...
public class MaritimeMoneyWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(MaritimeMoneyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MaritimeMoneyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MaritimeMoneyWLAIW/InitOutcome.xml").getDocumentElement();
